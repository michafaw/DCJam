...
if(didChangeStage) {
	...
	headSprites = [sprHeadSeedling1, sprHeadSeedling2, sprHeadSeedling3, choose(sprHeadJuvenile1, sprHeadJuvenile1), sprHead, choose(sprHeadRipe1, sprHeadRipe2), sprEmptyPart];
